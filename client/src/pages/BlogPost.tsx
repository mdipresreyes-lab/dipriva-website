      ...
      <main className="pt-24">
        <article className="py-12 sm:py-20">
          <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            {/* Top share row — right-aligned, sits just above the article body */}
            <motion.div
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
              transition={{ duration: 0.4, delay: 0.15 }}
              className="flex justify-end items-center gap-2 mb-10"
            >
              <span className="text-xs tracking-luxury uppercase mr-1" style={{ color: 'rgba(47,64,89,0.35)' }}>
              ...
              <a
                ...
                style={{ border: '1px solid rgba(47,64,89,0.18)', color: 'rgba(47,64,89,0.45)' }}
                onMouseEnter={e => { (e.currentTarget as HTMLElement).style.color = '#D4AF37'; (e.currentTarget as HTMLElement).style.borderColor = '#D4AF37'; }}
                onMouseLeave={e => { (e.currentTarget as HTMLElement).style.color = 'rgba(47,64,89,0.45)'; (e.currentTarget as HTMLElement).style.borderColor = 'rgba(47,64,89,0.18)'; }}
              >
              ...
              <button
                ...
                className="flex items-center justify-center w-7 h-7 rounded-full transition-colors"
                style={{ border: '1px solid rgba(47,64,89,0.18)', color: copiedTop ? '#D4AF37' : 'rgba(47,64,89,0.45)', borderColor: copiedTop ? '#D4AF37' : 'rgba(47,64,89,0.18)' }}
                onMouseEnter={e => { if (!copiedTop) { (e.currentTarget as HTMLElement).style.color = '#D4AF37'; (e.currentTarget as HTMLElement).style.borderColor = '#D4AF37'; } }}
                onMouseLeave={e => { if (!copiedTop) { (e.currentTarget as HTMLElement).style.color = 'rgba(47,64,89,0.45)'; (e.currentTarget as HTMLElement).style.borderColor = 'rgba(47,64,89,0.18)'; } }}
              >
                {copiedTop ? <Check className="w-3 h-3" /> : <Link2 className="w-3 h-3" />}
              </button>
            </motion.div>
